...
export const MOCKUPS: ReactNode[] = [
  ...
  <><div className="svc-row" style={{ display: "grid", gridTemplateColumns: "minmax(0, 4.2fr) minmax(0, 7.8fr)", gap: "clamp(28px, 4vw, 60px)", alignItems: "stretch", height: "100%" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
          <h3 style={{ margin: "0", fontSize: "clamp(23px, 2.1vw, 33px)", lineHeight: "1.12", letterSpacing: "-0.02em", fontWeight: "500", color: "#0A0E2A", textWrap: "balance" }}>CRM & Automation</h3>
          <p style={{ margin: "18px 0 0", fontSize: "15px", lineHeight: "1.6", color: "#565B72", maxWidth: "460px" }}>Customer relationship management, sales pipelines, and marketing automation. Track leads from first touch to closed deal with custom dashboards and workflows.</p>
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "10px", letterSpacing: "0.14em", color: "#8A8FA3", marginTop: "auto", paddingTop: "28px" }}>INCLUDES</div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginTop: "10px" }}>
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "11px", letterSpacing: "0.04em", fontWeight: "500", color: "#0526D9", background: "#FFFFFF", border: "1px solid #C9D2F2", borderRadius: "999px", padding: "5px 11px" }}>CRM IMPLEMENTATION</span>
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "11px", letterSpacing: "0.04em", fontWeight: "500", color: "#0526D9", background: "#FFFFFF", border: "1px solid #C9D2F2", borderRadius: "999px", padding: "5px 11px" }}>SALES PIPELINES</span>
            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "11px", letterSpacing: "0.04em", fontWeight: "500", color: "#0526D9", background: "#FFFFFF", border: "1px solid #C9D2F2", borderRadius: "999px", padding: "5px 11px" }}>MARKETING AUTOMATION</span>
          </div>
          </div>
          <div className="svc-card" style={{ position: "relative", height: "100%", minHeight: "clamp(280px, 38vh, 380px)", borderRadius: "18px", overflow: "hidden", background: "#DDE3FA" }}>
            <div style={{ position: "absolute", inset: "0", background: "url(\"/photos/growth-texture.jpg\") center / cover no-repeat" }}></div>
            ...
            <div style={{ position: "absolute", inset: "0", backgroundImage: "url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22160%22 height=%22160%22%3E%3Cfilter id=%22n%22%3E%3CfeTurbulence type=%22fractalNoise%22 baseFrequency=%220.85%22 numOctaves=%222%22/%3E%3C/filter%3E%3Crect width=%22160%22 height=%22160%22 filter=%22url(%23n)%22 opacity=%220.55%22/%3E%3C/svg%3E')", backgroundSize: "160px 160px", opacity: "0.35", mixBlendMode: "overlay" }}></div>
            <div style={{ position: "relative", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px", padding: "clamp(18px, 3vw, 30px)", boxSizing: "border-box" }}>
              <div style={{ background: "#FFFFFF", borderRadius: "14px", boxShadow: "0 28px 56px -24px rgba(15,20,40,0.5)", width: "min(360px, 95%)", height: "220px", display: "flex", overflow: "hidden", boxSizing: "border-box" }}>
                {/* Sidebar */}
                <div style={{ width: "48px", background: "#F9FAFC", borderRight: "1px solid #EEF0F4", display: "flex", flexDirection: "column", alignItems: "center", padding: "14px 0", gap: "14px", flex: "none" }}>
                  <div style={{ width: "22px", height: "22px", borderRadius: "6px", background: "#0526D9", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <div style={{ width: "10px", height: "10px", border: "1.5px solid #FFFFFF", borderRadius: "2px" }}></div>
                  </div>
                  <div style={{ width: "18px", height: "18px", borderRadius: "4px", background: "#E4E7F1" }}></div>
                  <div style={{ width: "18px", height: "18px", borderRadius: "4px", background: "#E4E7F1" }}></div>
                  <div style={{ width: "18px", height: "18px", borderRadius: "4px", background: "#E4E7F1" }}></div>
                </div>
                {/* Main */}
                <div style={{ flex: "1", display: "flex", flexDirection: "column" }}>
                  {/* Header */}
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderBottom: "1px solid #EEF0F4", flex: "none" }}>
                    <span style={{ fontSize: "13px", fontWeight: "750", color: "#0A0E2A" }}>Sales Pipeline</span>
                    <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "9px", color: "#8A8FA3", background: "#F3F5FC", padding: "4px 8px", borderRadius: "999px" }}>Q3 2026</span>
                  </div>
                  {/* Metrics */}
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "12px 16px", gap: "16px", borderBottom: "1px solid #EEF0F4", flex: "none", background: "#FCFDFD" }}>
                    <div>
                      <div style={{ fontSize: "9px", color: "#8A8FA3", fontFamily: "'IBM Plex Mono', monospace" }}>ACTIVE LEADS</div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "6px", marginTop: "4px" }}>
                        <span style={{ fontSize: "20px", fontWeight: "750", letterSpacing: "-0.02em", color: "#0A0E2A" }}>248</span>
                        <span style={{ fontSize: "10px", fontWeight: "650", color: "#1F8A5B" }}>+12%</span>
                      </div>
                    </div>
                    <div>
                      <div style={{ fontSize: "9px", color: "#8A8FA3", fontFamily: "'IBM Plex Mono', monospace" }}>PIPELINE VALUE</div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "6px", marginTop: "4px" }}>
                        <span style={{ fontSize: "20px", fontWeight: "750", letterSpacing: "-0.02em", color: "#0A0E2A" }}>$1.2M</span>
                        <span style={{ fontSize: "10px", fontWeight: "650", color: "#1F8A5B" }}>+8%</span>
                      </div>
                    </div>
                  </div>
                  {/* List */}
                  <div style={{ padding: "12px 16px", flex: "1", display: "flex", flexDirection: "column", gap: "12px" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "#FFE8D6", border: "1px solid #FFD3B6", flex: "none" }}></div>
                        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                          <div style={{ width: "56px", height: "6px", background: "#0A0E2A", borderRadius: "3px" }}></div>
                          <div style={{ width: "32px", height: "4px", background: "#C3C8DA", borderRadius: "2px" }}></div>
                        </div>
                      </div>
                      <div style={{ fontSize: "9px", fontWeight: "650", letterSpacing: "0.04em", color: "#E2582A", background: "#FFECE6", padding: "4px 6px", borderRadius: "4px" }}>NEGOTIATION</div>
                    </div>
                    
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "#E2F0FF", border: "1px solid #B8D8FF", flex: "none" }}></div>
                        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                          <div style={{ width: "48px", height: "6px", background: "#0A0E2A", borderRadius: "3px" }}></div>
                          <div style={{ width: "40px", height: "4px", background: "#C3C8DA", borderRadius: "2px" }}></div>
                        </div>
                      </div>
                      <div style={{ fontSize: "9px", fontWeight: "650", letterSpacing: "0.04em", color: "#1F8A5B", background: "#E2F5ED", padding: "4px 6px", borderRadius: "4px" }}>CLOSED WON</div>
                    </div>
                  </div>
                </div>
              </div>
